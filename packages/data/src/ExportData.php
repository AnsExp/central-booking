...
final class ExportData
{
    ...
    //         'operator_id' => $transport->get_operator()->get_user()->ID,
    ...
    //         'id' => $operator->get_user()->ID,
    //         'firstname' => $operator->get_user()->first_name,
    //         'lastname' => $operator->get_user()->last_name,
    //         'email' => $operator->get_user()->user_email,
    //         'username' => $operator->get_user()->user_login,
    //         'phone' => get_user_meta($operator->get_user()->ID, 'phone_number', true),
