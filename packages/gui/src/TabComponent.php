...
{
    /**
     * @var array{label: string, active: bool, content: ComponentInterface}
     */
    private array $tabs = [];
    ...
    public function add_tab(string $title, ComponentInterface $content, bool $active = false)
    {
        $this->tabs[] = [
            'label' => $title,
            'active' => $active,
