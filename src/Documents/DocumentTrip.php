...
final class DocumentTrip extends Document
{
    private Route $route;
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><?= git_time_format($this->route->departure_time) ?></td>
                    <td>Nombre:</td>
                ...
                <tr>
                    <td>Actividad:</td>
                    <td><?= git_get_text_by_type($this->transport->type) ?></td>
                    <td>Puerto de arribo:</td>
                    <td><?= $this->route->get_destiny()->name ?></td>
                    <td>Hora estimada de arribo:</td>
                    <td><?= git_time_format($this->plus_time($this->route->departure_time, $this->route->duration_trip)) ?></td>
                    <td>Matrícula:</td>
                    <td><?= $this->transport->code; ?></td>
                    <td>Cap. pasajeros:</td>
                    <td><?= $this->transport->get_meta('capacity') ?></td>
                </tr>
            </tbody>
        </table>
        <table>
            ...
            <tbody>
                ...
                foreach ($this->passengers as $passenger):
                    ...
                    <tr>
                        ...
                        <td colspan="3"><?= $passenger->data_document ?></td>
                        <td colspan="3"><?= $passenger->nationality ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td colspan="2"><?= $passenger->get_ticket()->get_order()->get_billing_phone() ?></td>
                        <td colspan="2"><?= $passenger->get_ticket()->get_coupon()?->post_title ?></td>
                    </tr>
                    <?php
                    $index++;
                endforeach;
