...
final class ActivitiesLogView implements Displayer
{
    public function display()
    {
        ?>
        <div class="wrap">
            <h1 class="wp-heading-inline">Log de Actividades</h1>
            <?php
    ...
    {
        $tabs = $this->get_tabs();
        $current_tab = $_GET['tab'] ?? 'passengers';
    ...
    private function get_tabs()
    {
        return [
            'passengers' => [
                'title' => 'Pasajeros',
                'callback' => function () {
                    (new TablePassengersLog())->display();
                }
            ],
            'tickets' => [
                'title' => 'Tickets',
