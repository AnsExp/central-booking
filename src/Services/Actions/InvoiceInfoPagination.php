...
final class InvoiceInfoPagination
{
     ...
     */
    public function fetch_tickets(): array
    {
     ...
     */
    public function fetch_all_tickets(): array
    {
    ...
    private function get_coupons()
    {
        if ($this->coupon !== null)
            return [$this->coupon];
        return $this->operator->get_coupons();
    }

    private function get_tickets_by_sql(bool $use_pagination = true): array
    {
